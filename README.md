...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/pac4j-yiban) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)

pac4j-yiban is a pac4j 5.0.x extension that adds YiBan (易班) Light App
...
| pac4j       | 5.0.x                           |
| pac4j-uniauth | `3.0.x.x.20260630-SNAPSHOT`     |
...
```groovy
implementation 'io.github.easy4j:pac4j-yiban:3.0.x.x.20260630-SNAPSHOT'
```
